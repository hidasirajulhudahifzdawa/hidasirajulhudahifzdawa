...
payments.forEach((payment) => {
    ...
    const upiUrl = `upi://pay?pa=${encodeURIComponent(payment.upiId)}&pn=${encodeURIComponent(payment.name)}&am=${payment.debt}&cu=INR&tn=${encodeURIComponent('Payment for Exam Fee')}`;
